...
- 利用者から依頼を受け取り、`spec.md` 第1〜4節をドラフトした（**まだ確定していない。Gate 1が未実施**）。
...
Gate 2（`prompts/drift-detector.md` の7問）も、`project-intake` 追加分の差分に対して未実施です。
...
> 手順3を機械で止まるブロックに差し替えて緑にしてある（F-20260827-11）。
